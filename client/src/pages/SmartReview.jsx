...
export default function SmartReview({ profile }) {
  ...
  const reviewSteps = ['Select', 'Preview', 'Review', 'Results'];
    ...
    return (
      <div className="min-h-screen py-8" style={{ background: 'linear-gradient(to bottom right, var(--gradient-from), var(--gradient-to))' }}>
        <div className="max-w-4xl mx-auto p-6">
          <StepIndicator steps={reviewSteps} currentStep={3} />
          {/* Mini stats bar */}
      ...
      <div className="min-h-screen py-8" style={{ background: 'linear-gradient(to bottom right, var(--gradient-from), var(--gradient-to))' }}>
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto mb-2">
            <StepIndicator steps={reviewSteps} currentStep={1} />
          </div>
          <SessionPreview
    ...
    return (
      <div className="min-h-screen py-8" style={{ background: 'linear-gradient(to bottom right, var(--gradient-from), var(--gradient-to))' }}>
        <div className="max-w-4xl mx-auto px-6 mb-2">
          <StepIndicator steps={reviewSteps} currentStep={2} />
        </div>
        {/* Mini stats bar */}
